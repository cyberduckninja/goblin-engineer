...
struct abstract_manager_service : public basic_manager_service_t<async_policy> {
  template <class... Args>
  abstract_manager_service(Args &&... args)
      : basic_manager_service_t(std::forward<Args>(args)...) {}
